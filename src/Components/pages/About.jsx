...
import foto1 from './pexels-rafael-cosquiere-2041540.jpg'
import foto2 from './pexels-lisa-fotios-1472841.jpg'
import foto3 from './pexels-tima-miroshnichenko-10626502.jpg'
import foto4 from './pexels-stas-knop-5939401.jpg'
        ...
        <div className="container mt-5">
            <div className="row">
                ...
                <div className="col-lg-6">
                    <img src={foto1} alt="Chi Siamo" className="img-fluid rounded mb-4" />
            ...
            <div className="row mt-5">
                <div className="col-md-4">
                    <div className="text-center">
                        <img src={foto2} alt="Impegno 1" className="img-fluid rounded-circle mb-2" />
                ...
                <div className="col-md-4">
                    <div className="text-center">
                        <img src={foto3} alt="Impegno 2" className="img-fluid rounded-circle mb-2" />
                ...
                <div className="col-md-4">
                    <div className="text-center">
                        <img src={foto4} alt="Impegno 3" className="img-fluid rounded-circle mb-2" />
